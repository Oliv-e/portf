    ...
    {/* For me in future, dont make a new porto instead use this one. rn i dont need links so i dont do responsive navbar. */}
        <nav className="hidden md:block w-full px-4 pt-1">
            <div className="w-10/12 mx-auto navbar-container flex flex-row justify-between items-center text-[#30475E]">
                <h1 className="font-bold ml-8 text-gray-800">オリバー</h1>
        ...
        <nav className="w-full px-2">
            <div className="w-full md:w-10/12 mx-auto navbar-container flex flex-row justify-between items-center">
                <span className="hidden md:block ml-8 font-edu absolute mx-auto py-4 flex border w-fit bg-gradient-to-r blur-xl from-blue-500 via-violet-500 to-red-500 bg-clip-text text-2xl box-content font-extrabold text-transparent text-center select-none">
                    OLIVER DILLON
                </span>
                <h1 className="hidden md:block ml-8 font-edu relative top-0 w-fit h-auto py-4 justify-center flex bg-gradient-to-r items-center from-blue-500 via-violet-500 to-red-500 bg-clip-text text-2xl font-extrabold text-transparent text-center select-auto">
                    OLIVER DILLON
                </h1>
                <span className='hidden md:block'></span>
                <span className="block md:hidden ml-8 font-edu absolute mx-auto py-4 flex border w-fit bg-gradient-to-r blur-xl from-blue-500 via-violet-500 to-red-500 bg-clip-text text-2xl box-content font-extrabold text-transparent select-none">
                    オリバー
                </span>
                <h1 className="block md:hidden ml-8 font-edu relative top-0 w-fit h-auto py-4 justify-center flex bg-gradient-to-r items-center from-blue-500 via-violet-500 to-red-500 bg-clip-text text-2xl font-extrabold text-transparent select-auto">
                    オリバー
                </h1>
