    ...
    <>
      <div className='w-full'>
        <div className='w-10/12 pt-24 pb-52 mx-auto'>
          <div className='flex flex-col gap-8 items-center'>
            ...
            <div className='text-white bg-gray-800 md:bg-transparent p-4 rounded-xl md:text-gray-800'>
              <h1 className="text-5xl font-roboto pb-1 animate-fade-up animate-delay-1000 border-b border-white md:border-gray-800">OLIVER DILLON</h1>
      ...
      <div className="w-full py-8 text-white bg-gray-800">
        <div className='w-10/12 mx-auto'>
            ...
            <p className='text-2xl font-roboto'>I’m Oliver Dillon from Indonesia! <br />
      ...
      <div className="w-full py-8 text-white bg-gray-800">
        <div className='w-10/12 mx-auto text-center'>
            ...
            <div className='my-28 grid grid-cols-1 gap-4 md:grid-cols-3'>
      ...
      <div className="w-full py-10 text-white bg-gray-800">
        <div className='w-10/12 mx-auto text-center font-roboto'>
            <div className='mt-10'>
              <div className='animate-fade-up grid grid-cols-2'data-twe-animation-start="onScroll">
                <div className='border-e-2 pb-20 relative text-end pe-20 border-white'>
                  ...
                  <div className='bg-gray-700 p-4 rounded-lg'>
                    <span className='text-xl'>At this time, I started to have some interest in coding. In Aug 2019, I am a new Vocational High School student at SMK 7 Pontianak, Majoring in software engineering, started learning Web Basics and created my landing page website.</span>
                  </div>
                </div>
                <div className='border-s-2 pb-20 text-start ps-20 border-white'>
                  <span className='text-xl'>August, 2019</span>
                </div>
              </div>
              <div className='animate-fade-up animate-delay-1000 grid grid-cols-2'>
                <div className='border-e-2 pb-20 relative text-end pe-20 border-white'>
                  <div className='absolute -right-[43px] -top-[30px] border bg-white z-10 rounded-full'>
                    <img src="https://bnsp.go.id/assets/img/favicon.png" className='w-20 h-20 p-3 rounded-xl' alt="" />
                  </div>
                  <div>
                    <span className='text-xl'>March, 2022</span>
                  </div>
                </div>
                <div className='border-s-2 pb-20 text-start ps-20 border-white'>
                  <div className='bg-gray-700 p-4 rounded-lg'>
              ...
              <div className='animate-fade-up animate-delay-[2000ms] grid grid-cols-2'>
                <div className='border-e-2 pb-20 relative text-end pe-20 border-white'>
                  <div className='absolute -right-[43px] -top-[30px] border bg-white z-10 rounded-full'>
                  ...
                  <div className='bg-gray-700 p-4 rounded-lg'>
                    <span className='text-xl'>I continued my education at <a href="https://polnep.ac.id" className='underline'>State Polytechnic of Pontianak</a> majoring in Informatics Engineering.</span>
                  </div>
                </div>
                <div className='border-s-2 pb-20 text-start ps-20 border-white'>
              ...
              <div className='animate-fade-up animate-delay-[3000ms] grid grid-cols-2'>
                <div className='border-e-2 pb-20 relative text-end pe-20 border-white'>
                  <div className='absolute -right-[43px] -top-[30px] border bg-white z-10 rounded-full'>
                  ...
                  <div>
                    <span className='text-xl'>Feb, 2023</span>
                  </div>
                </div>
                <div className='border-s-2 pb-20 text-start ps-20 border-white'>
                  <div className='bg-gray-700 p-4 rounded-lg'>
            ...
            <h2 className='text-xl my-4 text-center text-gray-300 font-edu'>To Be Continue..</h2>
        </div>
      </div>
      <div className="w-full py-12 text-white bg-black/[0.5]">
        <div className='w-10/12 mx-auto'>
